...
public class OrderSummaryActivityTest {
    ...
    public void clickSendEmailButton_SendsEmail() {
        // The following code lets us get access to the resources to get the email message string
        String emailMessage = InstrumentationRegistry.getTargetContext().getResources().getString(R.string.email_message);
        onView(withId(R.id.send_email_button)).perform(click());
        // In the intended method, we match the type of intent and type of data passed accordingly
        intended(allOf(
